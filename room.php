            ...
            <div class="carousel-inner">
              <?php foreach ($imageUrls as $index => $imageUrl): ?>
                <div class="carousel-item <?= ($index === 0) ? 'active' : ''; ?>">
                  <img class="w-100 h-100 d-block" src="Users/<?php echo substr($imageUrl['img_path'], 3); ?>"
                    alt="Room Image" onclick="openImageModal('<?php echo $imageUrl['img_path']; ?>')">
                </div>
              <?php endforeach; ?>
            </div>
            ...
            <div class="row justify-content-start">
              <div class="col-md-auto">
                <div style="display:contents;">
                  ...
                  $ownerPhoto = str_replace('..','Users',$ownerPhoto)
                  ?>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                foreach ($reviews as $review) {
                  ...
                  $stud_r_img = str_replace("..", "Users", $stud_photo);
                  echo '<tr>';
                  echo '<td>';
                  echo '<div class="d-flex" style="margin-top: 0;margin-left: 0;">';
                  echo "<img class='rounded-circle flex-shrink-0 me-3 fit-cover' width='47' height='44' src='$stud_r_img' style='margin-left: 3px;'>";
                  echo '<div>';
        ...
        <div class="col-md-6">
          <div id="contact-1"
            ...
            <div class="container" style="height: 302.234px;margin-top: 0px;">
              ...
              <div class="row">
                <div class="col-lg-12">
                  <form action="" method="POST" id="contactForm-1" name="contactForm" onsubmit="return loginfirst()">
                    <div class="card mb-5">
                      <div class="card-body p-sm-5">
                          <form action="" method="" onsubmit="return loginfirst()">
                            ...
                            <div>
                              <button class="btn btn-primary d-block w-100" type="submit" onclick="loginfirst()" name="submit">Submit Review</button>
                            </div>
                          </form>
                      </div>
                    </div>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                foreach ($reviews as $review) {
                  ...
                  $formattedDate = $dateTime->format('d-m-Y');
                  // Display the information as needed
                  $stud_s_img = str_replace("..", "Users", $stud_photo);
                  echo '<tr>';
                  echo '<td>';
                  echo '<div class="d-flex" style="margin-top: 0;margin-left: 0;">';
                  echo "<img class='rounded-circle flex-shrink-0 me-3 fit-cover' width='47' height='44' src='$stud_s_img' style='margin-left: 3px;'>";
                  echo '<div>';
                  echo "<p class='fw-bold mb-0' style='margin-top: 11px;'>$stud_fname $stud_lname</p>";
                  echo '</div>';
                  echo '<div class="d-inline-flex" style="height: 36px;margin: 3px;margin-left: 46px;margin-right: 38px;">
        ...
        <div class="col-md-6">
          <div id="contact-2"
            ...
            <div class="container" style="height: 302.234px;margin-top: 0px;">
              ...
              <div class="row">
                <div class="col-lg-12">
                  <form action="" method="" id="contactForm-2" name="contactForm" onsubmit="return loginfirst()">
                    <div class="card mb-5">
                      <div class="card-body p-sm-5">
                        ...
                        <div><button class="btn btn-primary d-block w-100" type="submit" name="submit" onclick="loginfirst()">Send </button>
                        </div>
                      </div>
                    </div>
                  </form>
