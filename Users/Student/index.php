    ...
    <div class="row mb-5">
      <form method="POST">
        <div class="col-10 text-center mx-auto">
          <h2 style="font-size: 24px;margin-bottom: 18px;"><strong><em>Search &amp; Filter the Rooms that fit's you . .
                .</em></strong></h2>
          <div>
        ...
        <div class="card" style="border-radius: 19px;">
          ...
          <div class="card-body p-4" style="box-shadow: 0px 0px;">
            ...
            <div style="margin:10px; height:44px;">
              <a class="btn btn-primary d-inline-flex float-end"
                href="addToFavorites.php?roomId=<?php echo $room['room_id']; ?>"
      ...
      <div class="col">
        <div class="card" style="border-radius: 19px;">
          ...
          <div class="card-body p-4" style="box-shadow: 0px 0px;">
            ...
            <div style="height: 43px;margin: 0;margin-left: 0;margin-top: 23px;padding: 1px;">
              <a class="btn btn-warning text-capitalize d-inline-flex float-start" role="button"
                href="room.php?room_id=<?php echo $room['room_id']; ?>" name="see_room">View Details</a>
